...
import {WelcomePage, Header,ListHeader, NewList, EditList, FoodCardCollection, Info, ItemInfo, EditItem, NoteCreateForm, ListCardCollection} from "./ui-components";
...
<Routes>
<Route exact path='/' element={<div><ListHeader/><ListCardCollection/></div>} />
...
<Route exact path='/newList' element={<div><Header/><NewList/></div>} />
